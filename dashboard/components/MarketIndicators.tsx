 ...
 * 시장 지표 카드
 *
 * 목적: 암호화폐 시장의 핵심 지표들을 실시간으로 모니터링하기 위함
 * 역할: 공포탐욕지수, BTC 도미넌스, 김치 프리미엄 등 시장 심리와 상태 표시
 *
 * 주요 기능:
 * - 공포탐욕지수 표시 (0-100) 및 레이블 자동 분류
 * - BTC 도미넌스 (비트코인 시장 점유율) 표시
 * - 김치 프리미엄 (국내외 가격차) 표시
 * - 지수별 색상 코딩 (공포: 빨강, 중립: 노랑, 탐욕: 초록)
 * - 60초마다 자동 갱신
 * - Process1에서 5분마다 업데이트된 데이터 사용
 *
